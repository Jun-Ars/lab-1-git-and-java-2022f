...
public class IntroLabTest {
     ...
     */
    @Test(timeout = 100)
    public void testarshadju() {
        String expected = "Sup! My name is Junaid Arshad! I like dogs more than cats! Pineapple belongs on pizza!";
        String actual = IntroLab.arshadju();
